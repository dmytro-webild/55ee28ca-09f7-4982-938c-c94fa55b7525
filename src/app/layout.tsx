...
export const metadata: Metadata = {
  title: "EuroPitture | Tinteggiature Civili e Industriali",  description: "Tinteggiature professionali, risanamento murario e trattamenti ignifughi certificati in provincia di Mantova."};
