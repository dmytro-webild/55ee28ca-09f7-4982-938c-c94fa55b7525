...
export const metadata: Metadata = {
  title: "EuroPitture | Tinteggiature Civili e Industriali a Mantova",  description: "Pittura civile e industriale dal 1990. Risanamento murario, trattamenti ignifughi certificati e tinteggiature di qualità in provincia di Mantova.",  keywords: "tinteggiature Mantova, pittura civile, pittura industriale, trattamenti ignifughi, risanamento murario, verniciatura ignifuga",  openGraph: {
    title: "EuroPitture | Maestri Coi Colori Dal 1990",    description: "Soluzioni complete per tinteggiature civili, industriali e trattamenti ignifughi certificati.",    siteName: "EuroPitture S.r.l.",    type: "website"},
  robots: {
    index: true,
    follow: true,
  },
